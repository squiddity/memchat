...
Use one facility for the two-level topology: parent → coordinator → exact-assignment workers. Inspect the installed version and live tool schema; never infer compatibility from its name.
